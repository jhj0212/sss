...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/quanxian/css/gameCard.css">
...
<body>
    <!-- 父容器 -->
    <div class="container">
    <input value="<?php echo ($score); ?>" style="display: none;" name='score' id='score'/>
        <!-- 我的游戏积分 -->
        <div id="myCardContainer">
            <img src="/Public/quanxian/img/game/heart.png">
            <h3>我的游戏分数：</h3>
            <span class="myCard"><?php echo ($score); ?></span>
        </div>
        <!-- 积分奖励 -->
        <div id="cardGetGoods">
            <div>
    ...
    <script type="text/javascript" src="/Public/quanxian/js/gameCard.js"></script>
</body>
