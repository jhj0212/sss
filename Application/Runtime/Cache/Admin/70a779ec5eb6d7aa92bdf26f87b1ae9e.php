...
<head>
    ...
    <script type="text/javascript" src="/Public/quanxian/js/validate.js"></script>
    <title>员工信息</title>
...
<body class="main">
    <!-- 验证信息 -->
    <h3 id="reContent"></h3>
    <form action="<?php echo U('Admin/editAdmin');?>" method='post' class="" enctype="multipart/form-data">
        ...
        <div class="xinxi">
            <ul>
                <li>
                    <span>微信昵称：</span>
                    <input type="text" class=" " id="sys_nickname" name="sys_nickname" value="<?php echo ($data["sys_nickname"]); ?>" disabled/>
                </li>
                <li>
                    <span>手机号码：</span>
                    <input type="text" class=" " id="sys_phone_number" name="sys_phone_number" value="<?php echo ($data["sys_phone_number"]); ?>" placeholder="请输入手机号"/>
                </li>
                <li>
                    <span>职位：</span>
                ...
                <li>
                    ...
                    <div class="iDate full">
                        <input type="text" name="sys_attention_time" value="<?php echo ($data["sys_attention_time"]); ?>"/>
