...
<head>
    ...
    <title>预定报表</title>
    <link rel="stylesheet" type="text/css" href="/Public/quanxian/css/yuding.css" />
...
<body style="padding: 10px; ">
    <form action="<?php echo U('Admin/report',array('sid'=>$sid));?>" method='post' class="" enctype="multipart/form-data">
