...
<html>
	...
	<body>
		...
		<div class="slideTxtBox">
			<div class="hd">
				<ul>
					<li><a href="<?php echo U('seatNumber',array('sid' => $sid,'id'=>1));?>">大厅</a></li>
					<li><a href="<?php echo U('seatNumber',array('sid' => $sid,'id'=>0));?>">包房</a></li>
				</ul>
			</div>
			<div class="bd">
				<ul>
					<!--<li class="tianjia">-->
						<!--<a href="<?php echo U('addSeat',array('sid' => $person[0]['sid']));?>">-->
							<!--<img src="/Public/quanxian/img/jia.png"/></span>-->
						<!--</a>-->
					<!--</li>-->
					<?php if(is_array($person)): foreach($person as $key=>$data): ?><a href="
							<?php if($data["state"] == 1): echo U('changeSeat',array('table_id'=>$data['table_id'],'sid'=>$data['sid'],'state'=>$data['state'],'table_type'=>$data['table_type'])); endif; ?>">
							<li class="
								...
								<span>
									<?php if($data["is_order"] == 0): ?>提供预订<?php endif; ?>
