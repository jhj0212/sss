...
<!-- 验证信息 -->
<h3 id="reContent"></h3>
<form action="<?php echo U('Admin/staffBack');?>" method='post' class="" enctype="multipart/form-data">
    ...
    <img src="/Public/quanxian/img/toux.png" />
    ...
    <!--<div class="tijiao" >
        <div class="bu">
            <button type="button" id="submitBtn">返回</button>
        </div>
    </div>-->
</form>
</body>
